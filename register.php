<?php
	...
	if(!isset($_SESSION['username'])){
		header("Location:projectlogin.html");
}
?>
    ...
    <div class=" card">
      ...
      <div class=" card-body">
        ...
        <form class="needs-validation" action="connect.php" method="POST" enctype="multipart/form-data">
          ...
          <!-- project description -->
          <div class="form-group">
            <label for="inputProjectDetails">Project Abstract</label>
            <textarea class="form-control" name="teamProjectDetails" id="inputProjectDetails"
              placeholder="Enter project Abstract here" maxlength="5000" rows="3" required></textarea>
            <div class="invalid-feedback">
              Please enter valid information
            </div>
          </div>
          ...
          <div class=" row justify-content-center">
            <div class=" col-md-4" style="border:1px solid #7eb6e0; margin-left:15px;">
              <div class="form-group">
				...
				<label for="cvupload0">Attach CV</label>
                <input type="file" class="form-control" name="cvFile1[]" id="cvupload0" required />
              </div>
            ...
            <div class=" col-md-3" style="border:1px solid #7eb6e0; margin-left:20px;">
              <div class="form-group">
				...
				<label for="cvupload1">Attach CV</label>
                <input type="file" class="form-control" name="cvFile1[]" id="cvupload1" required />
              </div>
            ...
            <div class=" col-md-3" style="border:1px solid #7eb6e0; margin-left:20px;">
              <div class="form-group">
				...
				<label for="cvupload2">Attach CV</label>
                <input type="file" class="form-control" name="cvFile1[]" id="cvupload2" required />
              </div>
            </div>
